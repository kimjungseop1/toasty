...
class ShareResultListAdapter(
    private val context: Context,
    private val items: ArrayList<ResponseResultMatchDto.Sub1>
) : RecyclerView.Adapter<ShareResultListAdapter.NoticeHolder>() {
    ...
    fun updateData(newData: ArrayList<ResponseResultMatchDto.Sub1>) {
        items.clear()
        items.addAll(newData)
        notifyDataSetChanged()
    }

    fun addData(newData: ArrayList<ResponseResultMatchDto.Sub1>) {
